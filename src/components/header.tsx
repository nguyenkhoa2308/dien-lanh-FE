          ...
          <div className="flex items-center justify-between h-16 md:h-20">
            ...
            <Link href="/" className="flex items-center gap-3 flex-shrink-0">
              <div className="relative">
                <div className="w-11 h-11 bg-gradient-to-br from-[var(--primary)] to-[var(--primary-dark)] rounded-xl flex items-center justify-center shadow-lg shadow-[var(--primary)]/30 transform hover:scale-105 transition-transform">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    fill="currentColor"
                ...
                <div className="absolute -bottom-1 -right-1 w-4 h-4 bg-[var(--accent)] rounded-full flex items-center justify-center">
                  <span className="text-white text-[8px] font-bold">AC</span>
                </div>
              </div>
              <div className="hidden sm:block">
                <div className="text-xl font-bold text-[var(--gray-900)]">
                  Cool<span className="text-[var(--primary)]">Mart</span>
                </div>
            ...
            <div className="hidden md:flex flex-1 max-w-xl mx-8">
              <div className="relative w-full group">
                <input
                  ...
                  className="w-full px-5 py-3 pr-12 bg-[var(--gray-50)] border-2 border-[var(--gray-200)] rounded-xl text-sm text-[var(--gray-900)] placeholder-[var(--gray-500)] focus:outline-none focus:border-[var(--primary)] focus:bg-white transition-all"
                />
                <button className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-[var(--primary)] text-white rounded-lg hover:bg-[var(--primary-dark)] transition-colors">
                  {""}
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
          ...
          <div className="px-4 py-4 bg-[var(--gray-50)] border-t border-[var(--gray-200)]">
            ...
            <div className="relative mb-4">
              <input
                ...
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full px-4 py-3 pr-12 bg-white border border-[var(--gray-200)] rounded-xl text-sm"
              />
              <button className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-[var(--primary)] text-white rounded-lg">
                {""}
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
