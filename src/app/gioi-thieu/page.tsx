...
const faqs = [
  ...
  {
    question: "CoolMart có hỗ trợ trả góp không?",
    answer: "CoolMart hỗ trợ trả góp 0% lãi suất qua các ngân hàng và công ty tài chính uy tín như Home Credit, FE Credit, HD Saison, Kredivo. Thủ tục đơn giản, duyệt nhanh trong 15 phút với CMND/CCCD."
  },
  {
  ...
  {
    question: "Chính sách bảo hành của CoolMart như thế nào?",
    answer: "CoolMart cung cấp bảo hành chính hãng từ 12-24 tháng tùy sản phẩm, bảo hành máy nén lên đến 5 năm. Ngoài ra, khách hàng được bảo trì miễn phí năm đầu tiên (vệ sinh, kiểm tra gas, kiểm tra điện)."
  },
  {
    question: "Làm thế nào để chọn công suất máy lạnh phù hợp?",
    answer: "Công suất máy lạnh được tính dựa trên diện tích phòng: 1HP cho phòng 9-15m², 1.5HP cho 15-20m², 2HP cho 20-30m². Tuy nhiên, còn phụ thuộc vào hướng nhà, số người sử dụng, thiết bị tỏa nhiệt. Liên hệ CoolMart để được tư vấn chính xác nhất."
  },
  {
    question: "CoolMart có dịch vụ sửa chữa máy lạnh không?",
    answer: "CoolMart cung cấp dịch vụ sửa chữa, bảo trì máy lạnh tất cả các hãng. Đội ngũ kỹ thuật viên được đào tạo chuyên nghiệp, có chứng chỉ từ các nhà sản xuất. Báo giá minh bạch, bảo hành dịch vụ 3-6 tháng."
  },
];
...
const reviews = [
  ...
  },
  {
    ...
    rating: 5,
    date: "10/12/2024",
    comment: "Mua máy lạnh cho cả nhà, tổng 4 máy. Được giảm giá tốt, lắp đặt nhanh trong 1 ngày. Rất hài lòng với dịch vụ của CoolMart!",
    ...
    <>
      ...
      <section className="relative py-24 overflow-hidden">
        <div className="absolute inset-0">
          <Image src="/images/about/about-cta.png" alt="CoolMart" fill className="object-cover" />
